      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="mb">
          ...
          <p className="text-[15px] text-[var(--text2)] leading-[1.8] max-w-2xl">
            {/* This landing page does not hardcode policy templates.  */}
            All predefined and community policies are
            published in <span className="font-semibold text-[var(--text)]">megent.dev</span>.
          </p>
        </div>
      </div>
    </section>
